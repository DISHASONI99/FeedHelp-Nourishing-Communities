...
import com.example.a01.CreatePost
...
data class Post(val content: String, val username: String, val likes: Int, val contentImageURL: String? = null, val id: String? = null, val likedUsers: List<String> = listOf(), val timestamp: Timestamp? = null)
        ...
        firestore.collection("posts")
            ...
            .addOnSuccessListener { documents ->
                for (document in documents) {
                    ...
                    val post = Post(content, username, likes, contentImageURL, id, likedUsers, timestamp)
                    data.add(post)
                }
